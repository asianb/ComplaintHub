...
import {View,Text,TextInput,TouchableOpacity,ActivityIndicator,StyleSheet,Animated, ScrollView,Alert,} from 'react-native';
...
const ProfileScreen = ({ navigation }) => {
  ...
  //     console.log("Fetching with token:", token); // לבדיקה
  ...
  //       // אם הטוקן לא תקין, נחזיר למסך ההתחברות
